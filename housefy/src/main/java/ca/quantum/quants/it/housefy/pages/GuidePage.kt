...
fun GuidePage() {
    LazyColumn(
        ...
        item {
            Text(
                text = "Understanding the Air Quality Index (AQI)\n",
                fontSize = 21.sp,
        ...
        item {
            Text(
                text = "Understanding Energy Consumption\n",
                fontSize = 20.sp,
                fontWeight = FontWeight.Bold
            )
            Text(
                text = "When we speak of energy consumption, it's typically measured in kilowatt-hours (kWh). To put it in perspective, a 1,000-watt appliance uses 1 kWh of electricity for one hour of operation. The average energy consumption varies significantly based on location, season, and lifestyle, but we can share some broad estimates based on U.S. and Canadian statistics.\n" +
                        "\n" +
