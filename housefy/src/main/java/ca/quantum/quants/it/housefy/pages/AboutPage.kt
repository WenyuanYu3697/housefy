    ...
    MaterialTheme {
        Scaffold(
            ...
            LazyColumn(
                ...
                item {
                    Text(text = "About Housefy\n",
                        fontSize = 20.sp,
                        fontWeight = FontWeight.Bold)
                    Text(text = "Housefy is an innovative smart home Internet of Things (IoT) application that seamlessly integrates technology into every corner of your home, elevating your everyday living experience.\n" +
                            "\n" +
