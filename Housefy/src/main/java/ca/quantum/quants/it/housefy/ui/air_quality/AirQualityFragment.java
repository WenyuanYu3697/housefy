...
public class AirQualityFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        AirQuialityViewModel airQuialityViewModel =
                new ViewModelProvider(this).get(AirQuialityViewModel.class);

        binding = FragmentAirQualityBinding.inflate(inflater, container, false);
        View root = binding.getRoot();

        final TextView textView = binding.textAirQuality;
        airQuialityViewModel.getText().observe(getViewLifecycleOwner(), textView::setText);
        return root;
    }
